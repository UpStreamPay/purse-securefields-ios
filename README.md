...
// Package.swift
dependencies: [
    .package(url: "https://github.com/UpStreamPay/vault-ios.git", from: "0.1.0")
]
```

Or add via Xcode: **File → Add Package Dependencies** → `https://github.com/UpStreamPay/vault-ios.git`
